...
//             <NavItem>
//               <NavLink
//                 className={this.state.activeTab === "photos" ? "active" : " "}
//                 onClick={() => {
//                   this.toggle("photos");
//                 }}
//               >
//                 <FontAwesomeIcon icon="th" /> Photos
//               </NavLink>
//             </NavItem>
//             <NavItem>
//               <NavLink
//                 className={this.state.activeTab === "saved" ? "active" : " "}
//                 onClick={() => {
//                   this.toggle("saved");
//                 }}
//               >
//                 <FontAwesomeIcon icon={["far", "bookmark"]} /> Saved
//               </NavLink>
//             </NavItem>
//           </Nav>
//         </div>
...
//               <Button href="#a" outline color="primary" className="btn-pill">
//                 Load More
//               </Button>
//             </div>
//           </TabPane>
